...
import 'package:app_08_prompt_library_manager/app.dart';
import 'package:app_08_prompt_library_manager/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('프롬프트 라이브러리 매니저'), findsWidgets);
